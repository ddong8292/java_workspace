 ...
 * GUI컴포넌트를 윈도우에 올려놓을때 배치방법을 결정지을 수 있는
 * 기능을 지원한다.
 * 자바는 LayoutManager라는 객체를 지원하고 다음과 같이 
 * 유형에 알맞는 배치관리자(LayoutManager)를 선택해서
 * 사용하면 된다.
 * 
 * 1.BorderLayout(동,서,남,북 센터의 방위가 지원되는 배치관리자)
...
public class WindowTest {
	...
	public static void main(String[] args) {
		...
		TextField t_td=new TextField(15);
